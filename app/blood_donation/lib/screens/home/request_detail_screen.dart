...
// Removed the flutter_map_cancellable_tile_provider import
    ...
    return Column(
      ...
      children: [
          ...
          child: FlutterMap(
            ...
            children: [
              TileLayer(
                ...
                // Use the default NetworkTileProvider from flutter_map
              ...
              MarkerLayer(
                markers: [
                  Marker(
                    ...
                    //     url +=
                    //         '${data?.locationCoordinates[1]},${data?.locationCoordinates[0]}';
        ...
        Visibility(
          ...
          child: ElevatedButton.icon(
            onPressed:
                requestProcessing ? null : markRequestAsCompleted,
